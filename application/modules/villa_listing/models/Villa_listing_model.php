 ...
 * Time: 2:47 PM
 */
class Villa_listing_model extends MY_Model {
    ...
    function get_villas($per_page, $offset, $sortfield, $orderBy, $search_string, $id=0)
    {
        if(empty($id)){
        ...
        $query = $this->db->get_where('villa', array('id_villa' => $id));
    ...
    public function record_count($search_string) {
       ...
       return $this->db->count_all_results("villa");
    }
}