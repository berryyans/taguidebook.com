...
$url = base_url () .'hotel_listing/index/';
?>
<div class="">

<div class="container">
<div class="panel panel-warning outer">
    <div class="panel-heading headerbar"><h3>Daftar Hotel</h3></div>
    <div class="panel-body">
        ...
        <tr>
            ...
            <th><?php echo anchor('hotel_listing/index/'.$field_name.'/'.($sort_by == $field_name ? $sort_order : 'asc').'/'.$page.'/'.$search_string, $field_display); ?></th>
            <?php endforeach;?>
            <th>Aksi</th>
        </tr>
        </thead>
        ...
        <tr>
            ...
            <td data-title='Aksi'><a href="<?=base_url();?>hotel_listing/detail/<?php echo $rec->id_hotel; ?>" class="btn btn-hover color-9 btn-hover color-9 btn-hover color-9 btn-sm padding-50 text-center" style="color:#ffffff;padding: 5% !important">Lihat Selengkapnya</a></td>
        </tr>
        <?php $i++; endforeach; ?>
        </tbody>
        </table>
