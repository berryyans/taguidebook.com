...
<body>
    <div class="container">
        ...
        <div class="login-form">
			...
			<form action="<?=base_url();?>member/send" method="POST" class="form-signin text-center" method="post" accept-charset="utf-8">
                <br>
                <div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div> 
				<div id="errors">
				    <?php echo $this->session->flashdata('error'); ?>
                ...
                <div class="form-group">
                    <input autocomplete="off" name="password" value="" type="password" class="form-control" placeholder="Password">
                </div>
                <div class="form-group">
                    <input autocomplete="off" name="repeatPassword" value="" type="password" class="form-control" placeholder="Confirm Password">
                </div>
                <button class="btn btn-block bt-login" type="submit">Register</button>

                <h5 class="text-center login-txt-center">Or Signin using social media</h5>
