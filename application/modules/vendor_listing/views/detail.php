         ...
         <div class="row">
            <div class="listing-box">
               <div class="col-md-3 mr-iob-blr">
                  ...
                  <div style="background: url(<?=site_url()."uploads/vendor/".$result->foto;?>) 0 0 no-repeat; height:30vh; background-size:cover; 
               ...
               <div class="col-md-8">
                  <ul class="cls-for-btn-listing">
                     <li>
                        <a href="<?=base_url();?>vendor_listing/index" class="margin-bottom-5"><i class="fa fa-reply"></i> Kembali Ke Daftar Vendor</a>
