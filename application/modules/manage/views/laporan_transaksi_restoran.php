<div class="container">
    <div class="row">
    	<div class="col-sm-12">
    		<h3>Laporan Transaksi Restoran</h3>
    		<hr>
		    <form method="post" name="frm" action="">
			    <table class="table table-bordered table-responsive">
					...
					<tr>
						<td width="150" height="25">Pilih Restoran</td>
						<td>
						<select name="id_restoran">
							<?php
							foreach ($restoran as $restoran){?>
							<option value="<?=$restoran->id_restoran;?>"><?=$restoran->nama;?></option>
							<?php
							}
							?>
						</select>
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<div class="alert alert-success">
    			Hasil Pecarian Transaksi bersadarkan Tanggal <?=$post_data['start_date'];?> s/d <?=$post_data['end_date'];?>, Restoran <?=$restorannya->nama;?>
    		</div>
    	</div>
    </div>
    <?php
