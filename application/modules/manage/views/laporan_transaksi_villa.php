    	...
    	<div class="col-sm-12">
		    ...
		    <form method="post" name="frm" action="">
			    <table class="table table-bordered table-responsive">
					...
					<tr>
						<td width="150" height="25">Pilih Villa</td>
						<td>
						<select name="id_villa">
							<?php
							foreach ($villa as $villa){?>
							<option value="<?=$villa->id_villa;?>"><?=$villa->nama;?></option>
							<?php
							}
							?>
						</select>
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<div class="alert alert-success">
    			Hasil Pecarian Transaksi bersadarkan Tanggal <?=$post_data['start_date'];?> s/d <?=$post_data['end_date'];?>, Villa <?=$villanya->nama;?>
    		</div>
    	</div>
    </div>
    <?php
