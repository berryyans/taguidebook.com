<div class="container">
    <div class="row">
    	<div class="col-sm-12">
    		<h3>Laporan Transaksi Driver</h3>
    		<hr>
		    <form method="post" name="frm" action="">
			    <table class="table table-bordered table-responsive">
					...
					<tr>
						<td width="150" height="25">Pilih Driver</td>
						<td>
						<select name="id_driver">
							<?php
							foreach ($driver as $driver){?>
							<option value="<?=$driver->id_driver;?>"><?=$driver->nama;?></option>
							<?php
							}
							?>
						</select>
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<div class="alert alert-success">
    			Hasil Pecarian Transaksi bersadarkan Tanggal <?=$post_data['start_date'];?> s/d <?=$post_data['end_date'];?>, Driver <?=$drivernya->nama;?>
    		</div>
    	</div>
    </div>
    <?php
