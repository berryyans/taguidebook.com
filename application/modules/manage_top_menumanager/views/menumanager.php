...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url() . 'manage_top_menumanager/tambahTopMenuManager' ?>">Add</a></li>
...
<div class="container">
    ...
    <h3><span class="glyphicon glyphicon-file"></span>Top Menu Manager</h3>
    <div class="row">
        <div class="col-md-6">
            <?php if (isset($search))
            { ?>
        ...
        <div class="col-md-6">
            <?php echo form_open('manage_top_menumanager/'); ?>
    ...
    <table class="table table-striped">
        ...
        if (isset($datas))
        {
            ...
            foreach ($datas as $data)
            {
                echo '<tr>';
                echo '<td>' . $index . '</td>';
                echo '<td><a href="' . base_url() . 'manage_top_menumanager/edittopmenumanager/' . $data->id . '" class="btn btn-primary">Edit</a>&nbsp;&nbsp;&nbsp;<button onclick="confirmDelete('.$data->id.',\'' . base_url() . 'manage_top_menumanager/deleteTopMenuManager/\')" class="btn btn-danger">Delete</button></td>';
