 ...
 * Time: 11:04 AM
 */
class Data_menumanager extends MY_Model {
    ...
    function returnparentmenus()
    {
        ...
        $sql =  "SELECT t0.*,
                        ...
                        t3.URL as lv13_link 
                   FROM menumanager t0 
              LEFT JOIN menumanager t1 ON t1.menu_parent = t0.id 
              LEFT JOIN menumanager t2 ON t2.menu_parent = t1.id 
              LEFT JOIN menumanager t3 ON t3.menu_parent = t2.id";
