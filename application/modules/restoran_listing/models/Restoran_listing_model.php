 ...
 * Time: 2:47 PM
 */
class Restoran_listing_model extends MY_Model {
    ...
    function get_restorans($per_page, $offset, $sortfield, $orderBy, $search_string, $id=0)
    {
        if(empty($id)){
        ...
        $query = $this->db->get_where('restoran', array('id_restoran' => $id));
    ...
    public function record_count($search_string) {
       ...
       return $this->db->count_all_results("restoran");
    }
}