...
<head>
    ...
    <?php
    if($nama_controller=="driver" || 
       $nama_controller=="dasboard_driver" || 
...
<body cz-shortcut-listen="true" class="" style="">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" style="">
            <div class="container">
                <a href="<?=base_url();?>dasboard_driver" class="navbar-brand">Dashboard</a>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent-7" style="">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a class="nav-link" href="<?=base_url();?>driver/driver">Driver</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url();?>driver/hotel">Hotel</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url();?>driver/villa">Villa</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url();?>driver/restauran">Restauran</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url();?>driver/vendor">Vendor</a></li>
                    </ul>
