...
<head>
    ...
    <?php
    if($nama_controller=="dasboard_vendor" || 
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" style="">
            <div class="container">
                <a href="<?=base_url();?>dasboard_vendor" class="navbar-brand">Dashboard</a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">
                                <a class="dropdown-item" href="<?=base_url();?>vendor/bank">Bank</a>
                                <a class="dropdown-item" href="<?=base_url();?>vendor/contact">Contact</a>
                                <a class="dropdown-item" href="<?=base_url();?>vendor/social_media">Social Media</a>
                                <a class="dropdown-item" href="<?=base_url();?>vendor/testimonial">Testimonial</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">
                                <a class="dropdown-item" href="<?=base_url();?>vendor/product">Product</a>
                                <a class="dropdown-item" href="<?=base_url();?>vendor/product_category">Product Category</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">                                
                                <a class="dropdown-item" href="<?=base_url();?>vendor/faq">FAQ</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>vendor/picture">Vendor Picture</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>vendor/video">Vendor Video</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">                                
                                <a class="dropdown-item" href="<?=base_url();?>vendor/transaksi">Histori Transaksi</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>vendor/kredit">Kredit Vendor</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>vendor/collect">Histori Collect</a>
                            </ul>
                        </li>
                    </ul>
