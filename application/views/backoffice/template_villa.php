...
<head>
    ...
    <?php
    if($nama_controller=="dasboard_villa" || 
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" style="">
            <div class="container">
                <a href="<?=base_url();?>dasboard_villa" class="navbar-brand">Dashboard</a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">
                                <a class="dropdown-item" href="<?=base_url();?>villa/bank">Bank</a>
                                <a class="dropdown-item" href="<?=base_url();?>villa/contact">Contact</a>
                                <a class="dropdown-item" href="<?=base_url();?>villa/social_media">Social Media</a>
                                <a class="dropdown-item" href="<?=base_url();?>villa/testimonial">Testimonial</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">
                                <a class="dropdown-item" href="<?=base_url();?>villa/room">Room</a>
                                <a class="dropdown-item" href="<?php echo base_url();?>villa/facility">Facility</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">                                
                                <a class="dropdown-item" href="<?=base_url();?>villa/faq">FAQ</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>villa/picture">Villa Picture</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>villa/video">Villa Video</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="directory">                                
                                <a class="dropdown-item" href="<?=base_url();?>villa/transaksi">Histori Transaksi</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>villa/kredit">Kredit Villa</a>
                                <a class="dropdown-item" href="<?php echo base_url()?>villa/collect">Histori Collect</a>
                            </ul>
                        </li>
                    </ul>
